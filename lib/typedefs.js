...
/**
 * @typedef {Object} Component.Animation
 * @property {String} type Animation type
 * @property {Number} fromX From x position
 * @property {Number} fromY From y position
 * @property {Number} toX To x position
 * @property {Number} toY To y position
 * @property {Number} fromColor
 * @property {Number} toColor
 * @property {Number} duration
 * @property {Number} elapsed
 * @property {Number} delay
 * @property {Object} shake
 */
...
/**
 * @typedef {Object} Entity.Animation
 * @property {Component.Animation} animation
 */
