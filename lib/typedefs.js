 ...
 * @param {Number} doorX Door x
 * @param {Number} doorY Door y
 */
 ...
 * @property {(tileX: number, tileY: number, range?: number) => Structure.Position[]} getVisibleTiles Get visible tiles from a position within a given range
 */
