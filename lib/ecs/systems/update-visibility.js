import { MapPosition, Selected } from "/lib/ecs/components/_index.js"
import { getMonsters, getMap } from "../ecs.js"
    ...
    selectedQuery.get().forEach((entity) => {
        ...
        tiles.forEach((tile) => {
            ...
            const monster = monsters.find(
                (entity) =>
                    entity.mapPosition.x === tile.x &&
                    entity.mapPosition.y === tile.y
            )
