...
export class GameContainer extends Container {
    ...
    drawEntities() {
        ...
        drawables.forEach(({appearance, mapPosition}) => {
            ...
            appearance.sprite.on('pointerdown', onMouseDown)
            appearance.sprite.on('pointerup', onMouseUp)
            appearance.sprite.on('pointermove', onMouseMove)
