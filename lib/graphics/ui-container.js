...
import { ZOOM_UI, TILE_SIZE, TILESET, TINTS } from '../../config.js'
...
export class UIContainer extends Container {
    ...
    draw() {
        ...
        this.drawRectangle(1, 14, 15, 7)
        this.createText('targetDescription', '', 2, 15)
        this.createText('targetHealth', '', 2, 16.5)
    }
    ...
    drawPointer() {
        ...
        this.pointer.tint = TINTS.POINTER
